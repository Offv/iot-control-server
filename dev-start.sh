...
echo "  HTR-A: 20.29 (IO-Link A) - Device ID: 00-02-01-6D-55-8A"
echo "  HTR-B: 20.33 (IO-Link B) - Device ID: 00-02-01-6D-55-86"
echo "  MQTT Topics: instrument/unit1/htr_a/temperature, instrument/unit1/htr_b/temperature"
echo ""
echo "Unit 2:"
echo "  Subnet: 30.x.x.x"
echo "  HTR-A: 30.29 (IO-Link A) - Device ID: 00-02-01-6D-55-8C"
echo "  HTR-B: 30.33 (IO-Link B) - Device ID: 00-02-01-6D-55-8D"
echo "  MQTT Topics: instrument/unit2/htr_a/temperature, instrument/unit2/htr_b/temperature"
